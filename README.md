force rebuild
title: Email RL Environment emoji: 📧 colorFrom: blue colorTo: purple sdk: docker pinned: false
📧 Email Classification RL Environment (OpenEnv)
🚀 Overview
This project implements a real-world Reinforcement Learning (RL) environment using the OpenEnv specification. The environment simulates an email classification system, where an AI agent learns to categorize emails into:
...
✔ Encourages correct decisions ✔ Penalizes wrong actions ✔ Supports learning over time
...
✔ Ensures fair and consistent evaluation ✔ Matches hackathon scoring constraints
